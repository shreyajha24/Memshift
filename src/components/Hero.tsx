    ...
    <section className="relative pt-28 pb-16 sm:pt-36 sm:pb-24 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-14">
          ...
          {/* Main Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.15] mb-5">
            Your internet <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 via-teal-400 to-indigo-500 dark:from-cyan-400 dark:via-teal-300 dark:to-indigo-400">memory.</span>
          </h1>

          {/* Supporting Text */}
          <p className="text-lg sm:text-xl font-medium text-slate-700 dark:text-slate-200 mb-3 tracking-tight">
            Save less. Remember more.
          </p>

          {/* Extended Supporting Explanation */}
          <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed mb-8">
            MemShift turns the things you discover online into an interconnected memory you can actually come back to.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 text-xs text-slate-500 dark:text-slate-400 font-mono">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span>100% Private local graph</span>
            </div>
          </div>
        </div>
